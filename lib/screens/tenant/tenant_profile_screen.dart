    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Row(
            children: [
              Expanded(child: _StatCard("Saved", savedCount.toString())),
              const SizedBox(width: 10),
              Expanded(child: _StatCard("Bookings", bookingsCount.toString())),
              const SizedBox(width: 10),
              Expanded(child: _StatCard("Reviews", reviewsCount.toString())),
            ],
          ),
        ],
      ),
