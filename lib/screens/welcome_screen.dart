...
import 'package:smart_rental_app/widgets/welcome_button.dart';
            ...
            child: Padding(
              ...
              child: Center(
                child: RichText(
                  ...
                  text: const TextSpan(
                    style: TextStyle(
                      color: Color.fromARGB(255, 34, 68, 160),
                    ), //add
                    children: [
                      TextSpan(
                        text: 'Welcome to Yuppies Lah!\n',
                        style: TextStyle(
                          fontSize: 45.0,
                      ...
                      TextSpan(
                        text: '\nDiscover places that fit your lifestyle',
                        style: TextStyle(
                          fontSize: 20,
                          // height: 0
                        ),
                ...
                children: [
                  Expanded(
                    child: WelcomeButton(
                      buttonText: 'Sign in',
                      onTap: SignInScreen(),
                      color: const Color.fromARGB(255, 44, 99, 219),
